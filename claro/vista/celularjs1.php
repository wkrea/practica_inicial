...
<html>
	...
	<script type="text/javascript">
		...
		$('#tabla').load('componentes/vista_celularjs.php');
	    });
	</script>
	<script type="text/javascript">
	    $(document).ready(function () {
